                              ...
                              <form action="" method="post">
                                  <div class="row">
                                      ...
                                      <div class="form-group col-md-6 mb-3">
                                          ...
                                          <input name="c_title" type="text" class="form-control form-control-dark font-primary-color" value="<?php echo $find_course_by_ID->c_title ?>">
                                      </div>
                                      <div class="form-group col-md-6 mb-3">
                                          <label class="font-primary-color mb-3">شناسه دوره (slug)</label>
                                          <input name="c_slug" type="text" class="form-control form-control-dark font-primary-color" data-jdp value="<?php echo $find_course_by_ID->c_slug ?>">
                                      </div>
                                      <div class="form-group col-md-6 mb-3">
