                        ...
                        <div class="singles_items">
                            <div class="education_block_grid style_2">
                                <div class="education_block_thumb n-shadow">
                                    ...
                                    <div class="cources_price">720 تومان</div>
                                </div>
                                ...
                                <div class="cources_info_style3">
                                    <ul>
                                        ...
                                        <li><i class="ti-time ml-2"></i>25دقیقه</li>
                                ...
                                <div class="education_block_footer">
                                    <div class="education_block_author">
                                        ...
                                        <h5><a href="instructor-detail.html">مهرداد نوروزی</a></h5>
                                    </div>
                                    <div class="foot_lecture"><i class="ti-control-skip-forward ml-2"></i>54 دوره</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="singles_items">
                            <div class="education_block_grid style_2">
                                <div class="education_block_thumb n-shadow">
                                    ...
                                    <div class="cources_price">289 تومان</div>
                                </div>
                                ...
                                <div class="cources_info_style3">
                                    <ul>
                                        ...
                                        <li><i class="ti-time ml-2"></i>4ساعت</li>
                                        <li><i class="ti-star text-warning ml-2"></i>4.7 امتیاز</li>
                                    </ul>
                                </div>
                                ...
                                <div class="education_block_footer">
                                    <div class="education_block_author">
                                        ...
                                        <h5><a href="instructor-detail.html">پریسا نصرتی</a></h5>
                                    </div>
                                    <div class="foot_lecture"><i class="ti-control-skip-forward ml-2"></i>26 دوره</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="singles_items">
                            <div class="education_block_grid style_2">
                                <div class="education_block_thumb n-shadow">
                                    ...
                                    <div class="cources_price">788 تومان</div>
                                </div>
                                ...
                                <div class="education_block_footer">
                                    <div class="education_block_author">
                                        ...
                                        <h5><a href="instructor-detail.html">علی خسروجردی</a></h5>
                                    </div>
                                    <div class="foot_lecture"><i class="ti-control-skip-forward ml-2"></i>52 دوره</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="singles_items">
                            <div class="education_block_grid style_2">
                                <div class="education_block_thumb n-shadow">
                                    ...
                                    <div class="cources_price">365 تومان</div>
                                </div>
                                ...
                                <div class="cources_info_style3">
                                    <ul>
                                        ...
                                        <li><i class="ti-time ml-2"></i>2ساعت</li>
                                ...
                                <div class="education_block_footer">
                                    ...
                                    <div class="foot_lecture"><i class="ti-control-skip-forward ml-2"></i>43 دوره</div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="education_block_grid style_2">
                                ...
                                <div class="education_block_footer">
                                    <div class="education_block_author">
                                        ...
                                        <h5><a href="instructor-detail.html">مهدی حسینی</a></h5>
                                    </div>
                                    <div class="foot_lecture"><i class="ti-control-skip-forward ml-2"></i>32 دوره</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="singles_items">
                            <div class="education_block_grid style_2">
                                <div class="education_block_thumb n-shadow">
                                    ...
                                    <div class="cources_price">895 تومان</div>
                                </div>
                                ...
                                <div class="education_block_footer">
                                    ...
                                    <div class="foot_lecture"><i class="ti-control-skip-forward ml-2"></i>48 دوره</div>
                                </div>
                            </div>
                        </div>
                        <!-- Single Slide -->
                        <div class="singles_items">
                            <div class="education_block_grid style_2">
                                <div class="education_block_thumb n-shadow">
                                    ...
                                    <div class="cources_price">560 تومان</div>
                                </div>

                                <div class="education_block_body">
                                    <h4 class="bl-title"><a href="course-detail.html">پروژه محور : نرم افزار کتابخانه با جاوا</a></h4>
                                </div>
                                ...
                                <div class="education_block_footer">
                                    <div class="education_block_author">
                                        ...
                                        <h5><a href="instructor-detail.html">مسعود صالحی</a></h5>
                                    </div>
                ...
                <div class="col-lg-8 col-md-7">
                    <div class="ed_detail_wrap">
                        ...
                        <div class="ed_header_short">
                            <p>
                                افزونه یا پلاگین (Plugin) به معنای نرم افزاری می باشد که به
                                برنامه اصلی امکانات جانبی و مکمل را اضافه می‌کند. در وردپرس
                                افزونه‌ها، امکاناتی را به این نرم افزار تحت وب افزوده و باعث
                                افزایش کارآیی آن می‌شوند. اما از آنجایی که گنجاندن امکانات
                                بیشتر باعث سنگین‌تر شدن آن می‌شود.
                            </p>
                        </div>
